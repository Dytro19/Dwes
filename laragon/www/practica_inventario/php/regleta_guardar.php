<?php
	...
	/*== Guardando datos ==*/
    $guardar_regleta=conexion();
    $guardar_regleta=$guardar_regleta->prepare("INSERT INTO regleta(regleta_codigo,regleta_nombre,regleta_precio,regleta_stock,regleta_foto,categoria_id,usuario_id) VALUES(:codigo,:nombre,:precio,:stock,:foto,:categoria,:usuario)");
    ...
    $guardar_regleta->execute($marcadores);

    if($guardar_regleta->rowCount()==1){
        echo '
            <div class="notification is-info is-light">
                <strong>¡regleta REGISTRADO!</strong><br>
                El regleta se registro con exito
            </div>
        ';
    }else{
        ...
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
                No se pudo registrar el regleta, por favor intente nuevamente
            </div>
        ';
    }
    $guardar_regleta=null;